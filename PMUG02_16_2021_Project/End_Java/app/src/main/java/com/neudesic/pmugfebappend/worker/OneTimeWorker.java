...
public class OneTimeWorker extends Worker {
    ...
    public Result doWork() {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), "OneTimeWorkRequest")
                    .setSmallIcon(R.drawable.ic_baseline_emoji_emotions_24)
                    .setContentTitle("This is my notification")
                    .setContentText("From one time work request! Hello!")
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("OneTimeWorkRequest", name, importance);
